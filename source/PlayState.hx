	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			case 'booth': // Week 3
				...
				var bg:BGSprite = new BGSprite('eva room', 550, 500, 0.95, 0.95);
				add(bg);
				bg.antialiasing = false;
				bg.setGraphicSize(Std.int(bg.width * 6));

				boothTable = new BGSprite('objects', bg.x, bg.y, 0.95, 0.95);
				boothTable.antialiasing = false;
				boothTable.setGraphicSize(Std.int(boothTable.width * 6));
		}
